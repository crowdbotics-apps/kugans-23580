"""kugans_23580 URL Configuration
...
admin.site.site_header = "Kugans"
admin.site.site_title = "Kugans Admin Portal"
admin.site.index_title = "Kugans Admin"

# swagger
api_info = openapi.Info(
    title="Kugans API",
    default_version="v1",
    description="API documentation for Kugans App",
)
